...
public class Party {
	...
	public Party() {
		...
		people.add(new Workaholic("My name is Patty", "I am a non-stop worker"));
		people.add(new CareFree("My name is Patrick", "I am a professional sleeper"));
		people.add(new Dog("Ruff", "Arf"));
		people.add(new CareFree("My name is Patty", "I am the same person"));
	}
